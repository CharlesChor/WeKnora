...
RUN --mount=type=cache,target=/go/pkg/mod \
    GOJIEBA_VERSION="$(go list -m -f '{{.Version}}' github.com/yanyiwu/gojieba)" && \
    cp -r "/go/pkg/mod/github.com/yanyiwu/gojieba@${GOJIEBA_VERSION}/deps/cppjieba/dict" /app/jieba-dict
