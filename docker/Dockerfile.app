...
RUN --mount=type=cache,id=go-pkg-mod,target=/go/pkg/mod make build-prod
RUN --mount=type=cache,id=go-pkg-mod,target=/go/pkg/mod cp -r /go/pkg/mod/github.com/yanyiwu/gojieba@v1.4.7/deps/cppjieba/dict /app/jieba-dict
